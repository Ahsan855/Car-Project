...
const Home = () => {
  ...
  return (
    <div className="flex py-40 px-4 justify-between items-center bg-[url('https://cdn.shopify.com/s/files/1/0037/2680/3011/files/s1.jpg?v=1535965822')] bg-cover bg-center w-full h-full">
      ...
      <div>
          <h1 className="text-blue-600 mt-10 w-3/6 font-sans text-left font-bold text-4xl">Stap Morgen <span className="text-blue-800 text-6xl italic">in AR Company</span></h1>
          <p className="text-gray-500 mt-10 text-xl w-3/5 my-auto text-left">Seating Mind sees 30% conversion increase, 47% boost in visitor spend after going exclusive with Fast.</p>
